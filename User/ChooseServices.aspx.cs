...
public partial class User_ChooseServices : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        //    if (ddlIdProof.SelectedValue == "AADHAR CARD")
        //    {
        //        string fileName = FUidproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "AADHAR_" + id + ext;
        //        FUidproof.PostedFile.SaveAs(Server.MapPath("Document/adhar_card/") + file);
        //    }

        //    if (ddlIdProof.SelectedValue == "VOTER ID CARD")
        //    {
        //        string fileName = FUidproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "VOTER_" + id + ext;
        //        FUidproof.PostedFile.SaveAs(Server.MapPath("Document/voter_id_card/") + file);
        //    }
        //    if (ddlIdProof.SelectedValue == "RATION CARD")
        //    {
        //        string fileName = FUidproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "RATION_" + id + ext;
        //        FUidproof.PostedFile.SaveAs(Server.MapPath("Document/Ration_card/") + file);
        //    }
        ...
        //{
        //    if (ddlAddressproof.SelectedValue == "AADHAR CARD")
        //    {
        //        string fileName = FUaddressproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "AADHAR_" + id + ext;
        //        FUaddressproof.PostedFile.SaveAs(Server.MapPath("Document/adhar_card/") + file);
        //    }

        //    if (ddlAddressproof.SelectedValue == "VOTER ID CARD")
        //    {
        //        string fileName = FUaddressproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "VOTER_" + id + ext;
        //        FUaddressproof.PostedFile.SaveAs(Server.MapPath("Document/voter_id_card/") + file);
        //    }
        //    if (ddlAddressproof.SelectedValue == "RATION CARD")
        //    {
        //        string fileName = FUaddressproof.FileName;
        //        string id = b.generateID("id", "Service_RequestData");
        //        string ext = System.IO.Path.GetExtension(FUidproof.FileName);
        //        file = "Ration_card_" + id + ext;
        //        FUaddressproof.PostedFile.SaveAs(Server.MapPath("Document/Ration_card/") + file);
        //    }
        ...
        cmd.CommandText = "Insert into Service_RequestData(id,customer_name,mobile_no,email_id,date,services,aadhar_card_photo,votar_card_photo,pan_card_photo,bank_id_photo,ration_card_photo,passport_photo,driving_license_photo,tc_photo,photo,payment_mode,others,service_note)values(@id,@cn,@mn,@ei,@d,@s,@ad,@vo,@fp,@bp,@fr,@pso,@dl,@tc,@ph,@pm,@o,@sn)";
    ...
    protected void rblsave_SelectedIndexChanged(object sender, EventArgs e)
    {

...
public partial class User_EditProfile : System.Web.UI.Page
{
    ...
    public void showuser()
    {
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "select first_name,middle_name,last_name,mobile_no,email_id from UserRegistration where user_id=@u";
        cmd.Parameters.AddWithValue("@u", Session["user_id"].ToString());
        cmd.Connection = con;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "update UserRegistration set first_name=@fn,middle_name=@mn,last_name=@lname,mobile_no=@n,email_id=@em where user_id=@u";

...
public partial class forgetpassword : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        if (txtMobile.Text == "")
        {
            cmd.CommandText = "select mobile,pwd from StudentRegistrationData where registration_no=@registration_no and email=@email";
            cmd.Parameters.AddWithValue("@email", txtEmail.Text);
        }
        else
        {
            cmd.CommandText = "select mobile,pwd from StudentRegistrationData where registration_no=@registration_no and mobile=@mobile";
        ...
        else
        {
            ...
            else
            {
                ...
                // SMS Code
                string msg = "Your Login Deatails are : %0a Registration No : " + txtRegistrationNo.Text + " %0a password : " + pwd + "%0a Do not share with anyone.";
                b.SendSms("VMVAMT", txtMobile.Text, msg);
